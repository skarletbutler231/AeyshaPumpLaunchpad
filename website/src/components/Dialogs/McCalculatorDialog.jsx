...
const McCalculator = ({ isOpen, onClose }) => {
    ...
    const calculatePumpfun = () => {
        const _solAmount = Math.sqrt(21 / 100 * (marketCapPump / solPricePump) * 79)
        setSnipedSolPump(_solAmount)
        const _tokenPercent = _solAmount * solPricePump * 100 / marketCapPump
        setSnipedTokenPercentPump(100 - _tokenPercent)
    }
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="!w-[800px] p-8">
                ...
                <div className="p-8 bg-gray-dark rounded-b-md">
                        ...
                        pageIndex == 0 ?
                            <div className={`w-full flex flex-col text-white font-sans gap-10 m-auto`}>
                                <div className="flex flex-col gap-3">
                                    ...
                                    <button
                                        className="w-full h-full font-medium font-conthrax text-center text-white uppercase px-6 py-4 rounded-lg justify-center items-center gap-2.5 inline-flex bg-green-button active:brightness-75 transition duration-100 ease-in-out transform focus:outline-none"
