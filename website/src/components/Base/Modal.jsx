...
export default function Modal(props) {
    ...
    return (
        <div className={`${isOpen ? "flex" : "hidden"} fixed top-0 left-0 w-full h-full bg-transparent flex flex-row items-center justify-center z-[999] ${props.className ? props.className : ""}`}>
