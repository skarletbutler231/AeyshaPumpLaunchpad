          ...
          <div className="!w-[800px] p-8 rounded-lg border border-white/10 bg-white/5 shadow-lg">
            {/* <div className='container-gradient w-full !p-px mb-6 flex !rounded-md !border !border-solid !border-gray-border gap-px text-md'>
              <div className={`${pageIndex == 0 ? "bg-green-button" : ""} w-1/2 rounded-md p-[1px]`}>
                <ExtendedButton className={`${pageIndex == 0 ? "bg-black/50" : "bg-transparent hover:bg-gray-highlight"} !h-full w-full uppercase`} onClick={() => setPageIndex(0)}>remove liquidity</ExtendedButton>
              </div>
              <div className={`${pageIndex == 1 ? "bg-green-button" : ""} w-1/2 rounded-md p-[1px]`}>
                <ExtendedButton className={`${pageIndex == 1 ? "bg-black/50" : "bg-transparent hover:bg-gray-highlight"} !h-full w-full uppercase`} onClick={() => setPageIndex(1)}>burn liquidity</ExtendedButton>
              </div>
            </div> */}
            {
              pageIndex == 0 ?
